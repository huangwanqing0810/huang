...
<script>
//  引入：此页面detail 后在router index.js中会跳转到detail index.vue 这是路由 
//        在detail index.vue中 引入两个组件 一个组件说明头部./DetailHead 另一个是买家评论的组件comment index.vue
//        在comment index.vue中 再次引入两个组件 说明在买家评论页面中分成两个部分./CommentHeader和CommentList'
